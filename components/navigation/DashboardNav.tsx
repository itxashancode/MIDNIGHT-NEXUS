...
export default function DashboardNav() {
  ...
  return (
    <div className="fixed top-6 left-1/2 -translate-x-1/2 w-full max-w-[1200px] px-6 z-[500]">
      <nav className="solidroad-nav grid grid-cols-2 md:grid-cols-3 items-center px-4 md:px-10">
        <div className="hidden md:flex items-center justify-start gap-6">
          ...
          <div className="hidden sm:flex items-center gap-2 p-1 rounded-full bg-white/[0.03] border border-white/5 relative group/protocol">
            <button 
