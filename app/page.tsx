          ...
          <div className="flex items-center justify-center gap-3">
            ...
            {exchanges.length > 0 && (
              <button 
                ...
                className="hidden lg:block text-[11px] font-subheading font-bold uppercase tracking-widest text-muted hover:text-destructive transition-colors px-2 py-1 ml-4"
              >
                Clear History
              </button>
            )}
